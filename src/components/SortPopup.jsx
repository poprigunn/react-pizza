...
const SortPopup = ({items, onClickSortByType, activeType}) => {
    const [visible, setVisible] = useState(false)
    const sort = useRef(null)
    const activeLabel = items.find(obj => obj.type === activeType).name

    useEffect(() => {
        document.body.addEventListener('click', visibleHandler)
    }, [])
